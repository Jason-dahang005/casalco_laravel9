<form action="{{ url('/apply-loan') }}" method="POST" enctype="multipart/form-data" class="this-form">
    <div class="content-form-page">
        ...
        <div class="col-lg-9 col-md-9">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name_of_member" placeholder="Enter name of member" value="@auth {{ $loan->first_name }} {{ $loan->middle_name }} {{ $loan->last_name }} @endauth">
        ...
        <div class="col-lg-3 col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="account_no" placeholder="Enter account no" value="@auth {{ $loan->acc_id }} @endauth">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="present_address" placeholder="Enter present_address" value="@auth {{ $loan->address }} @endauth">
        ...
        <div class="col-lg-12 col-md-12">
            ...
            @elseif (Request::is('lad-loan-application'))
                <input type="text" name="product_loan" value="none">
            @endif
        </div>
        ...
        <div class="col-lg-4 col-md-4">
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="date_of_birth" placeholder="Enter date of birth" value="@auth {{ $loan->dob }} @endauth">
        ...
        <div class="col-lg-4 col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="cellphone_no" placeholder="Enter Cellphone No." value="@auth {{ $loan->contact_number }} @endauth">
        ...
        <div class="col-lg-4 col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="tin_no" placeholder="Enter TIN No." value="@auth {{ $loan->TIN }} @endauth">
        ...
        <div class="col-lg-4 col-md-4">
            <div class="form-group">
                ...
                <input type="email" class="form-control" name="email_address" placeholder="Enter Email Address" value="@auth {{ $loan->email }} @endauth">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            @auth
                <button class="submit_btn" onclick="alert('Application Submitted Successfully!')" type="submit">SUBMIT APPLICATION</button>
            @endauth
